...
import { UserPlus, AlertCircle, Sparkles, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-lg w-full bg-white p-8 sm:p-10 rounded-3xl border border-brand-border/60 shadow-card">
        ...
        {/* 1-Click Google Sign Up (if Firebase is active) */}
        {isFbActive && (
          <div className="mb-5">
            <button
              type="button"
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-[10px] uppercase">
                <span className="bg-white px-2 text-slate-400 font-bold">Or Email Registration</span>
              </div>
            </div>
          </div>
        )}
